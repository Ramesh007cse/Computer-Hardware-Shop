...
$product_name = "POWER SUPPLY ANT ESPORTS FG750"; // Updated product name
$price = 6000; // Adjusted price for the power supply
...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <img src="psu.jpg" class="product-image img-fluid" alt="POWER SUPPLY ANT ESPORTS FG750"> <!-- Updated image source -->
        </div>
        <div class="col-md-6">
            <h2><?= htmlspecialchars($product_name) ?></h2>
            <p class="text-muted">Brand: <strong>ANT ESPORTS</strong></p>
            ...
            <table class="table mt-4 specs-table">
                <tr><td><strong>Wattage:</strong></td><td>750W</td></tr>
                <tr><td><strong>Efficiency:</strong></td><td>80+ Bronze</td></tr>
                <tr><td><strong>Form Factor:</strong></td><td>ATX</td></tr>
                <tr><td><strong>Modular:</strong></td><td>Non-Modular</td></tr>
                <tr><td><strong>Protection:</strong></td><td>OVP, UVP, OCP, SCP</td></tr>
    ...
    <div class="mt-5">
        ...
        <p>The ANT ESPORTS FG750 is a reliable 750W power supply designed to deliver stable and efficient power for your gaming or high-performance PC build. With 80+ Bronze certification, it offers great energy efficiency and is equipped with multiple protection features like OVP, UVP, OCP, and SCP to ensure your system's safety.</p>
    </div>
</div>
